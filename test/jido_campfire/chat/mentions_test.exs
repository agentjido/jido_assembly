defmodule Jido.Campfire.Chat.MentionsTest do
  ...
  test "resolves Campfire handles through persisted participants" do
  ...
  test "ignores email addresses and system handles" do
    ...
    assert Mentions.mentioned_user_ids("@campfire please archive this") == []
  end
end
