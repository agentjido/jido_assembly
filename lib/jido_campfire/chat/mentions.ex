defmodule Jido.Campfire.Chat.Mentions do
  @moduledoc """
  Resolves Campfire-local `@handle` mentions against persisted participants.

  `jido_messaging` owns participant storage. Campfire owns the workspace handle
